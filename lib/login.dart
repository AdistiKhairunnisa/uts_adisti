...
class _LoginPageState extends State<LoginPage> {
    ...
    return Scaffold(
      body: Container(
        ...
        decoration: BoxDecoration(
          ...
          Color.fromARGB(255, 73, 141, 213),
          Color.fromRGBO(185, 231, 246, 1),
        ])),
        ...
        child: Column(
          children: [
            ...
            TextButton(
                onPressed: () {},
                child: const Text(
                  "Or Forgot Password? Click Here",
                  style: TextStyle(color: Color.fromARGB(255, 62, 62, 62)),
                )),
            const SizedBox(height: 32),
            _buildButton("Login", Color.fromARGB(255, 112, 126, 234), () {
  ...
  Widget _buildTextField(String hint, TextEditingController controller,
    ...
    return Container(
      ...
      decoration: const BoxDecoration(
          color: Color.fromARGB(255, 204, 241, 241),
